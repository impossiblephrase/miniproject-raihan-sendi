...
-- AddForeignKey
ALTER TABLE `Point_Expiration` ADD CONSTRAINT `Point_Expiration_user_id_fkey` FOREIGN KEY (`user_id`) REFERENCES `Users`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
